...
int main(int argc, char *argv[])
{
    ...
    Source_Functor rsource_functor(rdataset, rate, app_start_time, batch_size, exec_mode, false);
    Source rsource = Source_Builder(rsource_functor)
                    .withParallelism(rsource_par_deg)
                    .withName(r_source_name)
                    .withOutputBatchSize(batch_size)
                    .build();
    Source_Functor lsource_functor(ldataset, rate, app_start_time, batch_size, exec_mode, false);
